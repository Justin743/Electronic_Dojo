...
INSERT INTO `customer` (`customer_ID`, `address`, `loyaltyPoints`, `user_ID`) VALUES
                                                                                  (158, '123 Tallaght Springfield', 0, 165),
                                                                                  (159, '123 Tallaght Springfield', 0, 166),
                                                                                  (160, '123 Tallaght Springfield', 0, 167);
...
INSERT INTO `order` (`order_ID`, `product_ID_order`, `date_of_order`, `total`, `payment_ID_order`, `customer_ID_order`) VALUES
                                                                                                                            (126, 3, '2024-04-28', 1000, 1, 159),
                                                                                                                            (127, 4, '2024-04-28', 1500, 1, 160),
                                                                                                                            (128, 1, '2024-04-28', 1239, 1, 158);
...
INSERT INTO `phone` (`phone_ID`, `manufacturer`, `image`, `product_ID_phone`) VALUES
...
INSERT INTO `user` (`ID`, `firstname`, `lastname`, `email`, `password`) VALUES
                                                                            (165, 'Justin', 'Juozaitis', 'justin.juoz99@gmail.com', 'Hello123??'),
                                                                            (166, 'Justin', 'Juozaitis', 'justin.juoz88@gmail.com', 'Hello123??'),
                                                                            (167, 'Justin', 'Juozaitis', 'justin.juoz77@gmail.com', 'Hello123??');
...
--
ALTER TABLE `customer`
    MODIFY `customer_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;

--
-- AUTO_INCREMENT for table `laptop`
--
ALTER TABLE `laptop`
    MODIFY `laptop_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `phone`
    MODIFY `phone_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `profile`
--
ALTER TABLE `profile`
    MODIFY `profile_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `television`
--
ALTER TABLE `television`
    MODIFY `television_ID` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `admin`
    ADD CONSTRAINT `admin_user_ID(FK)` FOREIGN KEY (`user_ID`) REFERENCES `user` (`ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
...
--
ALTER TABLE `order`
    ADD CONSTRAINT `customer_ID_order(FK)` FOREIGN KEY (`customer_ID_order`) REFERENCES `customer` (`customer_ID`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
--
ALTER TABLE `profile`
    ADD CONSTRAINT `customer_ID_FK` FOREIGN KEY (`customer_ID_profile`) REFERENCES `customer` (`customer_ID`) ON DELETE CASCADE ON UPDATE RESTRICT;
